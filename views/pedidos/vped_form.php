          ...
          <div class="mb-4">
            ...
            <select class="form-select form-select-lg" id="mesa_id" name="mesa_id" required>
              ...
              <?php foreach ($mesas ?? [] as $m): ?>
                <?php $mesaDisponible = ($m['estado'] === 'disponible'); ?>
                <option value="<?php echo e($m['id']); ?>" <?php echo $mesaDisponible ? '' : 'disabled'; ?>>
                  Mesa <?php echo e($m['numero']); ?>
                  <?php if (!$mesaDisponible): ?> (<?php echo ucfirst(e($m['estado'])); ?>)<?php endif; ?>
                </option>
              <?php endforeach; ?>
            </select>
            <div class="form-text">
