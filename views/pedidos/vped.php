...
<?php if (has_role('cliente')): ?>
  <div class="alert alert-info py-2">
    <i class="fa-solid fa-arrows-rotate me-1"></i>
    Seguimiento en tiempo real activo. Esta vista se actualiza cada 15 segundos.
  </div>
<?php endif; ?>
            ...
            <tr>
              ...
              <td>
                ...
                $statusConfig = [
                  ...
                  'listo' => ['class' => 'bg-primary-subtle text-primary-emphasis', 'icon' => 'fa-bell-concierge'],
                  'entregado' => ['class' => 'bg-success-subtle text-success-emphasis', 'icon' => 'fa-hand-holding-heart'],
              ...
              <td class="text-center pe-4">
                <div class="d-flex align-items-center justify-content-center gap-2 flex-wrap">
                  ...
                  <?php if (has_role(['admin', 'mesero', 'cajero'])): ?>
                    <form method="post" action="<?php echo BASE_PATH; ?>controllers/pedidos/cped.php?a=actualizar_estado" class="d-flex align-items-center gap-1">
                      <?php echo csrf_field(); ?>
                      ...
                      <select name="estado" class="form-select form-select-sm">
                        <?php foreach (['pendiente','en_preparacion','listo','entregado','completado','cancelado'] as $estadoOpt): ?>
                          <option value="<?php echo $estadoOpt; ?>" <?php echo $estadoOpt === $p['estado'] ? 'selected' : ''; ?>>
                            <?php echo ucfirst(str_replace('_', ' ', $estadoOpt)); ?>
                          </option>
                        <?php endforeach; ?>
                      </select>
                      <button class="btn btn-sm btn-outline-secondary" type="submit" title="Actualizar estado">
